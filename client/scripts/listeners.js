...
const registrationHTMLForm = '<div class="register"><header class="registration-header">' +
...
const signInHTMLForm = '<div class="register"><header class="signin-header"><h2>Inicia sesión</h2></header>' +
