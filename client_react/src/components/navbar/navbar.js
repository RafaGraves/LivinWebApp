...
import './navbar.css'
import houseImage from '../../svg/house-svgrepo-com.svg'
...
export default function Navbar() {
    ...
    function openModalRegister() {
        setModalRegister(oldState => !modalRegister);
    }
                ...
                <header
                    ...
                    <div className="col-md-3 mb-2 mb-md-0">
                        <a href="/" className="d-inline-flex link-body-emphasis text-decoration-none">
                            <img className="livin-svg-placeholder" src={houseImage} alt="image-house"/>
                        </a>
                    </div>
                    ...
                    <div className="col-md-3 text-end">
                        ...
                        <button type="button" className="btn btn-dark" onClick={openModalRegister}>Registrarse</button>
                    </div>
                </header>

            </div>
            {modalRegister && <ModalRegister state={openModalRegister}/>}
        </>
    )
}
